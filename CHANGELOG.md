...
- Compare code changes for [v453.1 to v454.0](https://github.com/BFF-AFIRMS/sgn/compare/bff-afirms-sgn-453.1..bff-afirms-sgn-454.0).
...
| -------------------------------------------------------- | ------- | -------------------------------- | ---------------------------------------------------------------------------------- |
| [PR #6095](https://github.com/solgenomics/sgn/pull/6095) | Bug     | solgenomics/topic/fix_datepicker | Fix design and edit trial datepicker                                               |
| [PR #6087](https://github.com/solgenomics/sgn/pull/6087) | Bug     | topic/fix_exif_verify            | Fix exif verification                                                              |
| [PR #5920](https://github.com/solgenomics/sgn/pull/5920) | Feature | solgenomics/topic/adding_dap     | Adds days after planting and days after last harvest                               |
| [PR #6082](https://github.com/solgenomics/sgn/pull/6082) | Feature | topic/plot_names                 | Make autogenerated name related functions more generic to support other name types |
| [PR #6108](https://github.com/solgenomics/sgn/pull/6108) | Bug     | topic/job_fixes                  | Let curator delete all jobs and fix finish logfile bug                             |
...
| Pull Request                                          | Type    | Branch                                                  | Description                                                      |
| ----------------------------------------------------- | ------- | ------------------------------------------------------- | ---------------------------------------------------------------- |
| [PR #74](https://github.com/BFF-AFIRMS/sgn/pull/74)   | Feature | BFF-AFIRMS/setraver/32-fieldmap                         | js: rewrite fieldmap using react                                 |
...
| [PR #76](https://github.com/BFF-AFIRMS/sgn/pull/76)   | Bug     | BFF-AFIRMS/setraver/styles                              | styles: adjust well and table margins                            |
| [PR #90](https://github.com/BFF-AFIRMS/sgn/pull/90)   | Bug     | BFF-AFIRMS/setraver/styles2                             | fieldmap: remove fixed width from button wrapper                 |
| [PR #109](https://github.com/BFF-AFIRMS/sgn/pull/109) | Bug     | BFF-AFIRMS/topic/styles-assorted                        | Styles: Fix overlapping components and consistify trial sections |
| [PR #115](https://github.com/BFF-AFIRMS/sgn/pull/115) | Bug     | BFF-AFIRMS/topic/fix-phenotype-download-headers         | download: fix phenotype column headers not matching row data     |
| [PR #73](https://github.com/BFF-AFIRMS/sgn/pull/73)   | Feature | BFF-AFIRMS/setraver/50-synonyms                         | lib: use trait synonyms instead of acronyms                      |
| [PR #121](https://github.com/BFF-AFIRMS/sgn/pull/121) | Feature | BFF-AFIRMS/feat/96-list-rename-group-column             | lists: change list table group column name to select             |
| [PR #122](https://github.com/BFF-AFIRMS/sgn/pull/122) | Bug     | BFF-AFIRMS/fix/113-datatables-scrollx-style             | styles: temporary fix for datatables scrollX problems            |
| [PR #124](https://github.com/BFF-AFIRMS/sgn/pull/124) | Feature | BFF-AFIRMS/feat/97-additional-pedigree-download-formats | download: additional export formats for pedigree                 |

## sgn-453.1

- Compare code changes for [v452.0 to v453.1](https://github.com/BFF-AFIRMS/sgn/compare/bff-afirms-sgn-452.0..bff-afirms-sgn-453.1).
