...
my @OPTIONAL_COLUMNS = qw|intercrop_stock_name plot_name is_a_control rep_number range_number row_number col_number stake set seedlot_name num_seed_per_plot weight_gram_seed_per_plot entry_number|;
