...
sub retrieve {
    ...
    my @possible_cols = ('plant_name','plant_id','subplot_name','subplot_id','plot_name','plot_id','accession_name','accession_id','plot_order','plot_number','block_number','is_a_control','rep_number','range_number','row_number','col_number','stake','set','seedlot_name','seed_transaction_operator','num_seed_per_plot','subplot_number','plant_number','pedigree','female_parent','male_parent','location_name','trial_name','year', 'planting_date', 'synonyms','tier','plot_geo_json');
