...
sub get_trials {
    ...
    JOIN nd_experiment_stock ON (accession.stock_id=nd_experiment_stock.stock_id or plot.stock_id=nd_experiment_stock.stock_id) JOIN nd_experiment_project USING(nd_experiment_id)
