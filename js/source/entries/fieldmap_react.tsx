                            ...
                            {!isTransposed && (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <text style={{ fontFamily: 'Roboto, sans-serif', fontSize: '70px', fontWeight: 572, whiteSpace: 'pre', fill: '#000000', textShadow: '0 0 10px white', transform: `rotate(${-northArrowRotation}deg)`, transformBox: 'fill-box', transformOrigin: 'center' }} x="76.43" y="35">N</text>
                                    </svg>
                                </div>
                            )}
