                    ...
                    jQuery.ajax({ // get trait synonyms
                        ...
                        success: function(response) {
                            ...
                            for (i = 0; i < list.length; i++) {
                                ...
                                var trait_display = parts.slice(0, -1).join("|");
                            //    synonym_fixed = synonym.replace(/"/g, "");
                            //    var syn_parts = synonym_fixed.split(" ");
                              //  synonym_fixed = syn_parts[0];
                                trait_html += '<option value="' + trait_id + '" data-synonym="' + synonym + '" data-list_name="' + trait_name + '" title="' + trait_display + '">' + trait_display + '</a>\n';
                            }
